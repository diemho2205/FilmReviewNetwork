...
<div class="w3-top  w3-theme-d2">
    <div class="w3-bar w3-justify w3-large" style="max-width: 60%; margin: 0 23%;">
        <a href={{ route('home') }} style="font-family: 'Anton'" class="w3-bar-item w3-button w3-padding-large">PHD</a>
        <div class="w3-dropdown-hover w3-hide-small w3-right">
            <button style="padding: 8px 5px !important;" class="w3-button" title="Notifications">
                <img src={{ asset((Auth::user()->personalProfile->avatar) ? Auth::user()->personalProfile->avatar : 'avatar.png' ) }} class="w3-circle" style="height:23px;width:23px" alt="Avatar">
            </button>     
